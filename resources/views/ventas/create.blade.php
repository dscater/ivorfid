...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <button class="btn btn-primary btn-lg waves-effect" id="registrar_venta"><i
                                    class="material-icons">save</i><span>REALIZAR VENTA</span></button>
                            {!! Form::close() !!}
                        </div>
                    </div>
                </div>
            ...
            <input type="hidden" value="{{ route('clientes.buscar') }}" id="urlBuscaCliente">
        </div>
    </section>
@endsection
